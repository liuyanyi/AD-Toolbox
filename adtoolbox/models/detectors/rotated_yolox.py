...
class RotatedYOLOX(RotatedSingleStageDetector):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(RotatedYOLOX, self).__init__(backbone, neck, bbox_head, train_cfg,
    ...
    def forward_train(self,
        ...
        losses = super(RotatedYOLOX, self).forward_train(img, img_metas, gt_bboxes,
    ...
    def _preprocess(self, img, gt_bboxes):
        ...
        if scale_x != 1 or scale_y != 1:
            ...
            for gt_bbox in gt_bboxes:
                ...
                gt_bbox[..., 2:4] = gt_bbox[..., 2:4] * math.sqrt(scale_x * scale_y)
